...
async function openP(id){
  ...
  if(isUpcoming){
    ...
    if(type==='yt'||type==='gd')html=`<iframe id="${type==='yt'?'yt-player-iframe':''}" src="${src}" allow="autoplay;encrypted-media;fullscreen" allowfullscreen></iframe>`;
