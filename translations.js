...
const TRANSLATIONS={
  pl:{
    ...
    nav_findbug:'🐛 Znajdź bug',findbug_title:'🐛 Znajdź bug',findbug_desc:'Znalazłeś błąd albo dziurę w bezpieczeństwie? Napisz do nas!',findbug_reward:'Opisz znaleziony bug lub lukę bezpieczeństwa i wyślij nam maila. Jeśli zgłoszenie okaże się prawdziwe — dostaniesz nagrodę! 🎁',
    credits_code_label:'Kod',credits_lead_label:'Prowadzi projekt',
    ...
    msg_conversations:'Konwersacje',msg_new_btn:'+ Nowa',msg_pick_conv:'Wybierz konwersację lub zacznij nową',
  ...
  en:{
    ...
    nav_findbug:'🐛 Find a bug',findbug_title:'🐛 Find a bug',findbug_desc:'Found a bug or a security hole? Write to us!',findbug_reward:'Describe the bug or security issue you found and send us an email. If it turns out to be real — you\'ll get a reward! 🎁',
    credits_code_label:'Code',credits_lead_label:'Leads the project',
    ...
    msg_conversations:'Conversations',msg_new_btn:'+ New',msg_pick_conv:'Select a conversation or start a new one',
  ...
  ru:{
    ...
    nav_findbug:'🐛 Найти баг',findbug_title:'🐛 Найти баг',findbug_desc:'Нашли баг или дыру в безопасности? Напишите нам!',findbug_reward:'Опишите найденный баг или уязвимость и отправьте нам письмо. Если сообщение окажется реальным — вы получите награду! 🎁',
    credits_code_label:'Код',credits_lead_label:'Руководит проектом',
    ...
    msg_conversations:'Беседы',msg_new_btn:'+ Новая',msg_pick_conv:'Выберите беседу или начните новую',
