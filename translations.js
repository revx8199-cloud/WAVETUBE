...
const TRANSLATIONS={
  pl:{
    ...
    call_status_calling:'Dzwonię...',call_status_incoming:'Dzwoni...',call_accept:'Odbierz',call_reject:'Odrzuć',call_hangup:'Rozłącz',call_mute:'Wycisz mikrofon',call_boost:'Głośniej (wzmocnienie)',call_quality_good:'Dobre połączenie',call_quality_medium:'Średnie połączenie',call_quality_bad:'Słabe połączenie',call_quality_checking:'Sprawdzanie połączenia...',
    ...
    form_title:'🎬 Dodaj film',form_subtitle:'YouTube, Google Drive, TikTok, MEGA i bezpośrednie linki MP4',
  ...
  en:{
    ...
    form_title:'🎬 Add video',form_subtitle:'YouTube, Google Drive, TikTok, MEGA and direct MP4 links',
  ...
  ru:{
    ...
    call_status_calling:'Звоним...',call_status_incoming:'Входящий звонок...',call_accept:'Принять',call_reject:'Отклонить',call_hangup:'Завершить',call_mute:'Выключить микрофон',call_boost:'Громче (усиление)',call_quality_good:'Хорошее соединение',call_quality_medium:'Среднее соединение',call_quality_bad:'Плохое соединение',call_quality_checking:'Проверка соединения...',
    ...
    form_title:'🎬 Добавить видео',form_subtitle:'YouTube, Google Диск, TikTok, MEGA и прямые ссылки MP4',
