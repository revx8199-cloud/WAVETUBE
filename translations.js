...
const TRANSLATIONS={
  pl:{
    ...
    btn_save:'Zapisz',btn_close:'Zamknij',btn_publish:'Opublikuj',btn_add:'Dodaj',
  ...
  en:{
    ...
    btn_save:'Save',btn_close:'Close',btn_publish:'Publish',btn_add:'Add',
  ...
  ru:{
    ...
    btn_save:'Сохранить',btn_close:'Закрыть',btn_publish:'Опубликовать',btn_add:'Добавить',
