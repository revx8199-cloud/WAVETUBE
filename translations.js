...
const TRANSLATIONS={
  pl:{
    ...
    call_status_calling:'Dzwonię...',call_status_incoming:'Dzwoni...',call_accept:'Odbierz',call_reject:'Odrzuć',call_hangup:'Rozłącz',call_mute:'Wycisz mikrofon',call_boost:'Głośniej (wzmocnienie)',
  ...
  en:{
    ...
    call_status_calling:'Calling...',call_status_incoming:'Incoming call...',call_accept:'Accept',call_reject:'Decline',call_hangup:'Hang up',call_mute:'Mute mic',call_boost:'Louder (boost)',
  ...
  ru:{
    ...
    call_status_calling:'Звоним...',call_status_incoming:'Входящий звонок...',call_accept:'Принять',call_reject:'Отклонить',call_hangup:'Завершить',call_mute:'Выключить микрофон',call_boost:'Громче (усиление)',
